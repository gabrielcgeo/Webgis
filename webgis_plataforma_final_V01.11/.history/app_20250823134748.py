...
def calculate_pricing_internal_detailed(data):
    ...
    try:
        ...
        for config in configs:
            print(f"Processando categoria: {config.category}, base_price: {config.base_price}")
            
            if config.category == 'projects':
            ...
            elif config.category == 'public_maps':
            ...
            elif config.category == 'page_views':
            ...
            elif config.category == 'employees':
            ...
            elif config.category == 'server_usage':
