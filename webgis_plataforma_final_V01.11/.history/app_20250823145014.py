...
def get_plan_prices():
    ...
    try:
        ...
        for plan_name, config in plans.items():
            # Calcular preço para cada plano
        ...
        # Aplicar desconto de 25% no plano Enterprise
        if 'enterprise' in plan_prices:
            enterprise_price = plan_prices['enterprise']['original_price']
            plan_prices['enterprise']['final_price'] = enterprise_price * 0.75
            plan_prices['enterprise']['discount'] = 25
        ...
        print(f"Erro ao buscar preços dos planos: {e}")
        return jsonify({
            'success': False,
            'error': str(e)
        }), 500
