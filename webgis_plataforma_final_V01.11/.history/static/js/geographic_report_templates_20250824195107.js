...
class TemplateManager {
    ...
    generateTemplatePreview(templateData) {
        ...
        // Verificar se é o template RIMA para mostrar preview especial
        if (templateData.id === 'rima') {
            return `
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="template-preview-visual">
                                <h6 class="mb-3">Preview Interativo do Template:</h6>
                                <iframe src="/geographic-report/template/rima" 
                                       style="width: 100%; height: 400px; border: 2px solid ${templateData.color}; border-radius: 8px;"
                                       title="Preview do Template RIMA">
                                </iframe>
                            </div>
                        </div>
                    </div>
