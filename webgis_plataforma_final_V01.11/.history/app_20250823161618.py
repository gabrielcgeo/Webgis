...
def api_contact():
    ...
    try:
        ...
        contact_message = ContactMessage(
            ...
            plano_escolhido=json.dumps(data['plano_escolhido'], ensure_ascii=False),
        ...
        print(f"DEBUG: Nova mensagem de contato recebida de {data['nome']} ({data['email']}) para o plano {data['plano_escolhido'].get('nome', 'N/A')}")
