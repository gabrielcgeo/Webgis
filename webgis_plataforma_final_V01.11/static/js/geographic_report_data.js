...
const SAMPLE_REPORTS = {
    ...
    // Relatório RIMA - Projeto Hidrelétrico Rio Forte
    'rima': {
        id: 'rima',
        title: 'RIMA - Relatório de Impacto Ambiental - UHE Rio Forte',
        description: 'Relatório completo de impacto ambiental para projeto hidrelétrico na bacia do Rio Doce',
        author: 'Equipe de Meio Ambiente',
        ...
        layers: [
            { id: 1, name: 'Limite do Projeto', type: 'polygon', visible: true, color: '#2c3e50' },
            { id: 2, name: 'Pontos de Sondagem', type: 'point', visible: true, color: '#e74c3c' },
            { id: 3, name: 'Pontos de Monitoramento Hídrico', type: 'point', visible: true, color: '#3498db' },
            { id: 4, name: 'Áreas de Supressão Vegetal', type: 'polygon', visible: false, color: '#e74c3c' },
            { id: 5, name: 'Áreas de Preservação Permanente', type: 'polygon', visible: true, color: '#27ae60' },
            { id: 6, name: 'Rede Hidrográfica', type: 'line', visible: true, color: '#3498db' }
        ],
        stops: [
            {
                id: 1,
                title: 'Introdução e Caracterização',
                description: 'Visão geral do projeto hidrelétrico e sua localização',
                mapPosition: { lat: -19.91, lng: -43.94, zoom: 12 },
                transition: 'fly-to',
                duration: 2000,
                content: {
                    text: 'O projeto da Usina Hidrelétrica (UHE) Rio Forte visa o aproveitamento do potencial energético do Rio Forte, na bacia do Rio Doce, em Minas Gerais. Este relatório apresenta a análise de viabilidade ambiental do empreendimento.',
                    images: [
                        { 
                            name: 'vista_aerea_projeto.jpg', 
                            caption: 'Vista aérea da área do projeto', 
                            url: '/static/images/sample/vista_aerea_projeto.jpg',
                            description: 'Visão aérea da área onde será construída a UHE Rio Forte'
                        }
                    ],
                    videos: [
                        { 
                            name: 'modelo_3d_barragem.mp4', 
                            caption: 'Modelo 3D da barragem', 
                            url: '/static/videos/sample/modelo_3d_barragem.mp4',
                            duration: '1:45',
                            description: 'Modelo tridimensional da concepção da barragem'
                        }
                    ]
                }
            },
            {
                ...
                description: 'Análise do substrato rochoso e relevo da região',
                mapPosition: { lat: -19.915, lng: -43.945, zoom: 14 },
                transition: 'fly-to',
                duration: 2000,
                content: {
                    text: 'A área do projeto está inserida no Cráton do São Francisco, caracterizada por rochas do Supergrupo Espinhaço. O relevo é classificado como "Mares de Morros", com topos arredondados e vales encaixados.',
                    images: [
                        { 
                            name: 'sondagem_geologica.jpg', 
                            caption: 'Ponto de sondagem geológica', 
                            url: '/static/images/sample/sondagem_geologica.jpg',
                            description: 'Equipamento de sondagem em operação'
                        }
                    ],
                    documents: [
                        { 
                            name: 'laudo_geologico.pdf', 
                            caption: 'Laudo Geológico Completo', 
                            url: '/static/documents/sample/laudo_geologico.pdf',
                            pages: 85,
                            description: 'Relatório técnico das sondagens geológicas'
                        }
                    ]
                }
            },
            {
                ...
                description: 'Monitoramento da qualidade da água e hidrologia',
                mapPosition: { lat: -19.92, lng: -43.95, zoom: 13 },
                transition: 'fly-to',
                duration: 2000,
                content: {
                    text: 'O monitoramento da qualidade da água foi realizado em 8 pontos estratégicos na Área de Influência Direta. Os resultados indicam boa qualidade hídrica na região.',
                    charts: [
                        { 
                            name: 'qualidade_agua.png', 
                            caption: 'Índice de Qualidade da Água (IQA)', 
                            url: '/static/charts/sample/qualidade_agua.png',
                            type: 'scatter',
                            description: 'Gráfico de dispersão dos valores de IQA por ponto de monitoramento'
                        }
                    ]
                }
            },
            {
                id: 4,
                title: 'Flora e Fauna',
                description: 'Inventário florestal e levantamento faunístico',
                mapPosition: { lat: -19.905, lng: -43.93, zoom: 14 },
                transition: 'fly-to',
                duration: 2000,
                content: {
                    text: 'O inventário florestal identificou três fitofisionomias principais. Foram registradas 120 espécies de aves, incluindo espécies de destaque como o gavião-carcará.',
                    images: [
                        { 
                            name: 'vegetacao_local.jpg', 
                            caption: 'Vegetação local da área do projeto', 
                            url: '/static/images/sample/vegetacao_local.jpg',
                            description: 'Fitofisionomia característica da região'
                        },
                        { 
                            name: 'gaviao_carcara.jpg', 
                            caption: 'Gavião-carcará (Caracara plancus)', 
                            url: '/static/images/sample/gaviao_carcara.jpg',
                            description: 'Espécie de ave frequentemente avistada na região'
                        }
                    ]
                }
            },
            {
                ...
                description: 'Análise demográfica e impactos sociais',
                mapPosition: { lat: -19.90, lng: -43.94, zoom: 11 },
                transition: 'fly-to',
                duration: 2000,
                content: {
                    text: 'A população dos municípios na área de influência soma 45.000 habitantes, com 60% residindo na zona urbana. O projeto trará benefícios econômicos e sociais para a região.',
                    charts: [
                        { 
                            name: 'piramide_etaria.png', 
                            caption: 'Pirâmide Etária da Região', 
                            url: '/static/charts/sample/piramide_etaria.png',
                            type: 'pyramid',
                            description: 'Distribuição populacional por faixa etária e gênero'
                        }
                    ]
                }
            }
